...
def run_test_make_simple_list():
    ...
    # Test 2 (add your test here): # Test 1:
    expected = [69, 70, 71, 72, 73]
    actual = make_simple_list(69, 73)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_simple_string():
    ...
    # Test 2:
    expected = '420-'
    actual = make_simple_string(420, 420)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def run_test_make_less_simple_string():
    ...
    # Test 2:
    expected = '420'
    actual = make_less_simple_string(420, 420)
    print('Expected:', expected)
    print('Actual:  ', actual)
...
def make_less_simple_string(m, n):
    ...
    """
    # -------------------------------------------------------------------------
    # ODNE: 7. Implement and test this function.
    #   Note that you should write its TEST function first (above).
    # -------------------------------------------------------------------------
    string = ''
    for k in range(m, n):
...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        circle = circles[k]
        rectangles = rectangles + (rg.Rectangle(rg.Point(circle.center.x-circle.radius, circle.center.y-circle.radius), rg.Point(circle.center.x+circle.radius, circle.center.y+circle.radius)),)
    return rectangles
